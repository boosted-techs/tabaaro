                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                            <div class="footer-widget__column footer-widget__about">
                                <div class="footer-widget__about-logo">
                                    <a href="/"><img src="/assets/logo2.png" class="image-color-invert" style="width:300px" alt=""></a>
                                </div>
                                <div class="footer-widget__about-text-box">
                                    <p class="footer-widget__about-text">Tabaaro Foundation is a nonprofit organization based in Uganda, dedicated to extending educational assistance to children facing neglect, orphanhood, and poverty. Our mission is to provide sponsorships and essential school supplies to empower vulnerable children to stay in school and build a brighter future. Join us in the noble cause of making a positive impact in the lives of Uganda's children.</p>
                                </div>
...
<!--                        </div>-->
                        <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                            <div class="footer-widget__column footer-widget__contact">
                                ...
                                <p class="footer-widget__contact-text">Kashari <br> Uganda
                                </p>
                                <ul class="list-unstyled footer-widget__contact-list">
                                    ...
                                    <li>
                                        ...
                                        <div class="text">
                                            <p><a href="tel:256700632657">+256 700 632657</a></p>
                                        </div>
                                    </li>
                                </ul>
        ...
        <div class="mobile-nav__wrapper">
            ...
            <div class="mobile-nav__content">
                ...
                <div class="logo-box">
                    <a href="/" aria-label="logo image"><a href="/"><img src="/assets/logo2.png" class="image-color-invert" style="width:250px" alt=""></a>
                </div>
                <!-- /.logo-box -->
